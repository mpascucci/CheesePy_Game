...
<img style="width: 100%;" src="./img/Screenshot.png" alt="screenshot of the game">
...
Move around using the keyboard arrow keys, but keep an eye on what is, you will see messages like these:
...
from .cheese import Buddy, start_game
